...
df[[11]] <- read.csv(
  ...
  dplyr::select(
    Subject, Blocktype, Shape, Label, Matching, 
    Label_Origin_Identity, Label_English_Identity, Label_Standardized_Identity,
    Shape_Origin_Identity, Shape_English_Identity, Shape_Standardized_Identity,
    RT_ms, RT_sec, ACC
  ) %>%
...
df[[12]] <- read.csv(
  ...
  dplyr::ungroup() %>%
  dplyr::select(
    Subject, Blocktype, Block, Trial, Shape, Label, Matching, 
    Label_Origin_Identity, Label_English_Identity, Label_Standardized_Identity,
    Shape_Origin_Identity, Shape_English_Identity, Shape_Standardized_Identity,
    RT_ms, RT_sec, ACC
  ) %>%
...
df[[62]] <- read.csv(
  ...
  dplyr::select(
    Subject, Block, Trial, Matching, 
    Shape_Origin_Identity, Shape_English_Identity, Standarlize_Identity,
    RT_ms, RT_sec, ACC
  ) %>%
  dplyr::arrange(
    Subject, Block, Trial
...
write.csv(x = pan_data, file = "../2_Raw_Data/Pan_2025/Pan_2025_Exp1_Clean.csv", row.names = FALSE)
```
